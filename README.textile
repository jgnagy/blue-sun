...
To install *{color:#00e}Blue Sun*, download the source and install any missing Ruby gems. Then, you need to configure the app to your liking (meaning edit "config/initializers/devise.rb" to match your configuration). After that, use @`rails`@ to start the server. More install info will be added later as there is actually something to run.

h2. Project Status

Currently, *{color:#00e}Blue Sun* does *nothing* it's supposed to, since it is nothing more than a base Rails 3 project. I'll update this section as I do more work on the project.
